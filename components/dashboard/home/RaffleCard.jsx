...
import { getRaffleSalesStats } from "@/lib/services/reports";
...
export default function RaffleCard({ raffle, onDelete }) {
  ...
  const stats = useMemo(() => getRaffleSalesStats(raffle.id), [raffle.id]);
    ...
    <>
      <article className="raffle-card">
        ...
        <div className="raffle-card__body">
          ...
          <div className="raffle-card__metrics">
            <div>
              <span>Vendas</span>
            ...
            <div>
              <span>Vendidos</span>
              <strong>{stats.numerosVendidos}</strong>
            </div>
            <div>
              <span>Pendentes</span>
            ...
            <div>
              <span>Receita</span>
              <strong>{fmtCurrency(stats.receita)}</strong>
            </div>
          </div>
          ...
          <div className="raffle-card__actions">
            ...
            <ShareRaffleButton raffle={raffle} className="btn btn--violet btn--sm" />
            <Link href={`/rifa/${raffle.id}`} target="_blank" className="btn btn--outline btn--sm">
