const DEFAULT_PIX_KEY = "contato@rifamaster.com.br";
const DEFAULT_MERCHANT_NAME = "RifaMaster";
...
export function createPixPayment({ raffle, numbers, pixKey, merchantName }) {
  ...
  return generatePixPayload({
    amount,
    pixKey: pixKey || raffle.pixKey || DEFAULT_PIX_KEY,
    merchantName: merchantName || raffle.pixMerchantName || raffle.title || DEFAULT_MERCHANT_NAME,
